...
ReactDOM.render(React.createElement(ListManager, { title: 'Ingredients', headingColor: '#028090' }), document.getElementById('ingredients'));
ReactDOM.render(React.createElement(ListManager, { title: 'toDo', headingColor: '#00A896' }), document.getElementById('todo'));
ReactDOM.render(React.createElement(ListManager, { title: 'Xmas', headingColor: '#05668D' }), document.getElementById('Xmas'));
ReactDOM.render(React.createElement(ListManager, { title: 'Watever', headingColor: '#d90429' }), document.getElementById('Watever'));
